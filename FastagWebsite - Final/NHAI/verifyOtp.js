document.addEventListener("DOMContentLoaded", function () {
    ...
    otpForm.addEventListener("submit", function (e) {
        ...
        const apiUrl = "http://localhost:8080/NHAI/newTollMailOTPVerification";
        ...
        fetch(apiUrl, {
            ...
            .then((responseText) => {
                ...
                OtpMessageContainer.innerHTML = "<p>" +responseText + "</p>";
                if(responseText == "OTP verified successfully! ") {
                    window.location.href = `addTollDetails.html`;
                }
            })
            .catch((error) => {
                // Handle any errors
                console.error("Error:", error);
                OtpMessageContainer.innerHTML = "<p>Error: An error occurred while processing your request.</p>";
            });
    });
