...
// Define the API URL
const apiUrl = 'http://localhost:8080/NHAI/transactionT';
...
// function displayPDF() {
//     const pdfUrl = 'http://localhost:8080/NHAI/createPdfT';
...
//     fetch('http://localhost:8080/NHAI/createPdfT', {
//         method: 'GET',
...
download.addEventListener('click', function() {
    ...
    .then(blob => {
        ...
        const a = document.createElement('a');
        a.href = url;
        a.download = 'TollTransactions.pdf'; // Specify the desired file name
        document.body.appendChild(a);
        a.click();
        window.URL.revokeObjectURL(url); // Clean up the URL object
    })
...
//     const csvUrl = 'http://localhost:8080/NHAI/createCsvT';
...
const downloadCsv = () => {
    ...
    xhr.open("GET", "http://localhost:8080/NHAI/createCsvT", true);
...
//     const ExcelUrl = 'http://localhost:8080/NHAI/createExcelT';
...
const downloadExcel = () => {
    const xhr = new XMLHttpRequest();
    xhr.open("GET", "http://localhost:8080/NHAI/createExcelT", true);
    xhr.setRequestHeader("Authorization", `Bearer ${jwtToken}`);
